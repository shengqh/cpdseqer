  ...
  for idx in range(0, len(coordinateFiles)):
    ...
    with open(coordinateFile, "rt") as fin:
      for line in fin:
        ...
        chrom = parts[0]
        catName = parts[3] if len(parts) >= 4 else defaultCat
