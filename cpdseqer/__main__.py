...
def main():
  ...
  parser_fig_position.add_argument('--space', action='store_true', help='Use space rather than tab in coordinate files')
  ...
  parser_uv_comp_genome_region.add_argument('--space', action='store_true', help='Use space rather than tab in coordinate file')
  ...
  parser_uv_comp_regions.add_argument('--space', action='store_true', help='Use space rather than tab in coordinate file')
  ...
  parser_uv_comp_groups_region.add_argument('--space', action='store_true', help='Use space rather than tab in coordinate file')
  ...
  #   statistic(logger, args.input, args.output, args.coordinate_list_file, args.space, args.add_chr, args.category_index)
    ...
    logger = initialize_logger(args.output + ".log", args)
    uv_comp_genome_region(logger, args.input, args.output, args.fasta, args.count_type, args.coordinate_file, args.size_factor_file, args.space, args.add_chr)
    ...
    logger = initialize_logger(args.output + ".log", args)
    uv_comp_groups(logger, args.input1, args.input2, args.output, args.count_type, args.size_factor_file)
  elif args.command == "uv_comp_groups_region":
    logger = initialize_logger(args.output + ".log", args)
    uv_comp_groups_region(logger, args.input1, args.input2, args.output, args.count_type, args.coordinate_file, args.size_factor_file, args.space, args.add_chr)
